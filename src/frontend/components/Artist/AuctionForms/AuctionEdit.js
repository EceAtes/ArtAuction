    ...
    <div className={styles.EditAuction}>
      ...
      <form className={styles.EditAuction}>
        <div className={styles.EditAuction}>
          ...
          <input className={styles.EditAuction} type="text" id="itemName" name="itemName" onChange={(e)=>setItemName(e.target.value)}/>
        </div>

        <div>
          <label className={styles.EditAuction} htmlFor="category">Category:</label>
          <select className={styles.EditAuction} id="category" name="category" onChange={(e)=>setCategory(e.target.value)}>
          ...
          <input className={styles.EditAuction} type="number" id="min-bid" name="min-bid" onChange={(e)=>setWidth(e.target.value)}/>
          
          <label className={styles.EditAuction} htmlFor="priority">Length:</label>
          <input className={styles.EditAuction} type="number" id="min-bid" name="min-bid" onChange={(e)=>setLength(e.target.value)}/>

        </div>
        <div className={styles.EditAuction}>
            <label className={styles.EditAuction} htmlFor="endDate">Start Date:</label>
            <input className={styles.EditAuction} type="date" id="endDate" name="endDate" onChange={(e)=>setStartDate(e.target.value)}/>

          <label className={styles.EditAuction} htmlFor="endDate">End Date:</label>
          <input className={styles.EditAuction} type="date" id="endDate" name="endDate" onChange={(e)=>setEndDate(e.target.value)}/>
        </div>

        <div>
          <label className={styles.EditAuction} htmlFor="priority">Minimum Bid Amound:</label>
          <input className={styles.EditAuction} type="number" id="min-bid" name="min-bid" onChange={(e)=>setMinBidAmount(e.target.value)}/>

          <label className={styles.EditAuction} htmlFor="bidIncrement">Bid Increment:</label>
          <input className={styles.EditAuction} type="number" id="bidIncrement" name="bidIncrement" onChange={(e)=>setBidIncrement(e.target.value)}/>
        </div>

        <div className={styles.EditAuction}>
          <label className={styles.EditAuction} htmlFor="description">Description:</label>
          <textarea className={styles.EditAuction} id="description" name="description" rows="4" onChange={(e)=>setDescription(e.target.value)}/>
        </div>
